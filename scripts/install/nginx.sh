...
APT="nginx libnginx-mod-http-fancyindex libnginx-mod-rtmp subversion ssl-cert php-fpm libfcgi0ldbl php-cli php-dev php-xml php-curl php-xmlrpc php-json php-mbstring php-opcache php-zip ${geoip} ${mcrypt}"
apt_install $APT
